...
export function getExpiryStatusColor(status: ExpiryStatus): string {
  switch (status) {
    case "fresh":
      return "bg-fresh-100 text-fresh-800 border-fresh-200";
    case "use_soon":
      return "bg-warning-100 text-yellow-800 border-warning-200";
    case "expiring":
      return "bg-orange-100 text-orange-800 border-orange-200";
    case "expired":
      return "bg-danger-100 text-danger-500 border-danger-200";
  }
}
...
export function estimateItemCost(
  ...
  // Rough cost estimates per unit for waste tracking
