    ...
    >
      ...
      <div
        className={cn(
          ...
          'glass-heavy rounded-3xl shadow-[0_24px_80px_rgba(0,0,0,0.18)]',
          sizeClasses[size],
        )}
      >
        {/* Header */}
        <div className="flex items-start justify-between px-6 py-5 border-b border-white/20">
          ...
          <button
            onClick={onClose}
            className="p-1.5 text-slate-400 hover:text-slate-600 rounded-xl hover:bg-slate-100/60 transition-all ml-4 flex-shrink-0"
            aria-label="Close"
          >
            <X className="w-4 h-4" />
          </button>
